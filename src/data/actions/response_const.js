...
export const REP_SET_DP_PARAMS = {
  dp_id: 'DP0',
  dp: {
    dpConnect_id: 'TA',
    dpName: 'SQL Запрос 1',
    dpObjects: [
      { dataType: 'Number', id: 'DP0.D1', name: 'Id', type: 'Dimension' },
      {
        dataType: 'Number',
        id: 'DP0.D7',
      ...
      { dataType: 'Datetime', id: 'DP0.D6', name: 'Дата', type: 'Dimension' }
    ],
    dpProperties: {},
    dpSql:
...
export const REP_SET_STRUCTURE_PARAMS = {
  report_id: 'R1',
  structure: {
    pgBody: {
      content: {
