                ...
                <div className={styles.tabs}>
                    ...
                    >
                        {activeTab === 1 ? (
                            ...
                            <>
                                <div>
                                    <p className={styles.viewActiveText}>
                                        просмотр
                                    </p>
                                    <p className={styles.viewItem}>
                                        {items[5].name}
                                    </p>
                                </div>
                    ...
                    >
                        {activeTab === 0 ? (
                            ...
                            <>
                                <div>
                                    <p className={styles.editActiveText}>
                                        редактирование
                                    </p>
                                    <p className={styles.editableItem}>
                                        {items[2].name}
                                    </p>
                                </div>
                                <div className={styles.actions}>
                                ...
                                <div className={styles.contentData}>
                                    ...
                                    <div
                                        className={clsx(styles.sidePanel, {
                                            [styles.sidePanelVisible]:
                                                isShowingPanel,
                                        })}
                                    >
                                        <SidePanel
                                            navType={
                                                SIDE_PANEL_TYPES.BLOCK_MENU
                                            }
                                            marginRight={
                                                reportDesigner.reportsUi.ui
                                                    .showReportPanel
                                                    ? 250
                                                    : 0
                                            }
