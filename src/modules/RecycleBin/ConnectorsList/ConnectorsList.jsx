...
const ConnectorsList = () => {
  ...
  const connectors = useSelector(state => state.app.trash);
  ...
  const listItems = foldersHistory[currentFolderIndex]?.items;
        ...
        <ListTableRowWithDropdown
          ...
          cells={
            <>
              ...
              <td>{item.type_name || TABLE_CELL_EMPTY_VALUE}</td>
              <td>{item.drop_dt || TABLE_CELL_EMPTY_VALUE}</td>
            </>
          }
        >
          {isFolder
