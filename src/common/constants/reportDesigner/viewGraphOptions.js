...
export const MeasureGaugeItems = [
  { value: 'avoidDuplicateRowAggregation', label: 'Избегать агрегирования дубликатов строк' },
  { value: 'showMeasureValuesWithEmptyGaugeValues', label: 'Показывать значения показателя с пустыми значениями измерения' },
  { value: 'showGaugeValuesWithEmptyMeasureValues', label: 'Показывать значения измерения с пустыми значениями показателя' },
  { value: 'showGaugeValuesWithZeroValue', label: 'Показывать значения показателя, когда значение = 0' },
