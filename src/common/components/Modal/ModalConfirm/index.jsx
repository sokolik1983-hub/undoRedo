        ...
        <>
            ...
            <div className={styles.modalConfirmWrapper}>
                <div className={styles.modalConfirmHeader}>
                    <WarnIcon />
                    <div className={styles.modalConfirmHeaderTitle}>
                        Внимание
                    </div>
                </div>
                <div className={styles.modalConfirmMiddle}>
                    ...
                    <span>
                        Если вы закроете окно, то потеряете все введенные данные
                    </span>
                </div>
                <div className={styles.modalConfirmButtons}>
                    ...
                    <Button buttonStyle={BUTTON.BIG_BLUE} onClick={onReturn}>
                        Отмена
                    </Button>
                </div>
            </div>
